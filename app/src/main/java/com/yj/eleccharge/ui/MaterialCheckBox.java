...
public class MaterialCheckBox extends CompoundButton {
    ...
    public MaterialCheckBox(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.MaterialCheckBox);
        mColor = attributes.getColor(R.styleable.MaterialCheckBox_checkbox_color,
                getResources().getColor(R.color.checkbox_color));
        mCheckedColor = attributes.getColor(R.styleable.MaterialCheckBox_checkbox_checked_color,
